...
public class CanPostTransformFromExternalPlanTest extends AbstractSilverJSONTest {
	...
	public void testCreateComponentsForExternalPlan() throws MojoExecutionException,
		...
		plan = new Plan();
		plan.componentPlan = Utils.getTestFile(CanPostTransformFromExternalPlanTest.class, 1, "component.json").getAbsolutePath();
		plan.stackPlan = Utils.getTestFile(CanPostTransformFromExternalPlanTest.class, 1, "stack.json").getAbsolutePath();
		
		DeployApplicationStack deploy =new DeployApplicationStack(this.config, plan);
		deploy.planFile = "src/test/resources/CanPostTransformFromExternalPlanTest/externalPlan.xml";

...
public class BEFromExternalPlanTest extends AbstractSilverJSONTest {
	...
	public void testCreateComponentsForExternalPlan() throws MojoExecutionException,
		...
		plan = new Plan();
		plan.componentPlan = Utils.getTestFile(BEFromExternalPlanTest.class, 1, "component.json").getAbsolutePath();
		plan.stackPlan = Utils.getTestFile(BEFromExternalPlanTest.class, 1, "stack.json").getAbsolutePath();
		
		DeployApplicationStack deploy =new DeployApplicationStack(this.config, plan);
		deploy.planFile = "src/test/resources/BEFromExternalPlanTest/externalPlan.xml";
